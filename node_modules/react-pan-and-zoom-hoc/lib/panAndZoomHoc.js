    ...
    return _a = /** @class */ (function (_super) {
            ...
            function PanAndZoomHOC() {
                ...
                _this.handleMouseDown = function (event) {
                    if (!_this.panning) {
                        ...
                        var _a = _this.normalizeTouchPosition(event, event.currentTarget), clientX = _a.clientX, clientY = _a.clientY;
                ...
                _this.handleMouseMove = function (event) {
                    if (_this.panning && event.currentTarget) {
                        var _a = _this.props, onPanMove = _a.onPanMove, renderOnChange = _a.renderOnChange;
                        var x = _this.props.x;
                        var y = _this.props.y;
                        var scale = _this.props.scale;
                        if (x !== undefined && y !== undefined && scale !== undefined) {
                            var _b = _this.normalizeTouchPosition(event, event.currentTarget), clientX = _b.clientX, clientY = _b.clientY;
                            var target = event.currentTarget;
            ...
            PanAndZoomHOC.prototype.render = function () {
                ...
                if (x !== undefined && y !== undefined && scale !== undefined) {
                    ...
                    return (React.createElement(WrappedComponent, __assign({}, passedProps, other, { onMouseDown: this.handleMouseDown, onMouseMove: this.handleMouseMove, onMouseUp: this.handleMouseUp, onTouchStart: this.handleMouseDown, onTouchMove: this.handleMouseMove, onTouchEnd: this.handleTouchEnd, onWheel: this.handleWheel }), children));
                }
                else {
                    return null;
                }
